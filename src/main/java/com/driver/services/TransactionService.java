...
public class TransactionService {
    ...
    public Transaction returnBook(int cardId, int bookId) throws Exception{
        ...
        //getting all the transactions done for a particular book and a card
        List<Transaction> transactions = transactionRepository5.find(cardId, bookId, TransactionStatus.SUCCESSFUL, true);
        Transaction transaction = transactions.get(transactions.size() - 1); //last transaction of that book in card
        ...
        List<Book> issuedBooks=c.getBooks();
        ...
        txn.setBook(transaction.getBook());
